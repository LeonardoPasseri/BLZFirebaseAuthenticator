...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of BLZFirebaseAuthenticator.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Leonardo Passeri/BLZFirebaseAuthenticator'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Leonardo Passeri' => 'leonardo@balzo.eu' }
  s.source           = { :git => 'https://github.com/Leonardo Passeri/BLZFirebaseAuthenticator.git', :tag => s.version.to_s }
